...
This is a hotfix release to bypass the new YouTube consent page shown to users in the European Union.

The current workaround is not guaranteed to work forever. It may be deprecated soon. You could say this is just a "warm fix".

No worries, though. The team is working to find a proper long-term solution to the problem.
