...
- Switch to the NewPipe repository by following [these directions](../blog/announcement/f-droid/pinned/f-droid-repo/) (if you had previously installed NewPipe from GitHub releases you will not have to uninstall NewPipe to switch)
