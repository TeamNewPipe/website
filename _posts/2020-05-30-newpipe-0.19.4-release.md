...
The extractor version was updated by [@Stypox](https://github.com/Stypox), bringing better performance. [@TobiGr](https://github.com/TobiGr) made a commit related to that as well. The [extractor update notes](https://github.com/TeamNewPipe/NewPipeExtractor/releases/tag/v0.19.4) better explain this.
