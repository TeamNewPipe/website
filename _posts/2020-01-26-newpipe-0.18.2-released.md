---
layout: post
title: "NewPipe 0.18.2 released: Hotfix for the Extractor"
...
8 days after the last release and the next one is already out: A hotifx for the Extractor!

## Hotfix

A hotfix release regarding the Extractor usually means that all the older versions of NewsPipe are likely to fail to play videos - this release is no difference. If you see any Guru Mediation error in the app, please update to this version before you create an issue (and/or verify that you actually have `0.18.2+` installed via hitting the `About` section in the left menu).
