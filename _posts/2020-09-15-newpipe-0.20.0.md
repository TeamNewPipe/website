...
<video src="/img/smart_button.mov" class="no-flow vertical" autoplay loop></video>
...
<video src="/img/landscape_swipe_down.mp4" class="no-flow" autoplay loop></video>
...
<img class="no-flow img-responsive" src="/img/screenshots/notification_9.png"/>
