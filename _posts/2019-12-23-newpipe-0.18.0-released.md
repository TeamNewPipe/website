...
<div class="flex-row image-row elements-2" style="display: flex; flex-wrap: nowrap; justify-content: space-around;">
<img class="no-flow img-responsive" style="padding-right: 5px; display:inline; width:50%" src="/img/screenshots/shot_navigation_drawer_peertube_instances.png"/>
<img class="no-flow img-responsive" style="padding-left: 5px; display:inline; width:50%" src="/img/screenshots/shot_settings_content_peertube_instances.png"/>
</div>
