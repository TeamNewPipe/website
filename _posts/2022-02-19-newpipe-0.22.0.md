...
- A Polish translation of the README was added by [@Radplay](https://github.com/Radplay). You want more languages? Well we also have one in Traditional Chinese (used in Taiwan) now, added by [@akamayu-ouo](https://github.com/akamayu-ouo). Thank you!
