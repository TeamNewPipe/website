...
This is a special notification type available for media apps since Android (5.0) Lollipop, colour-matching its theme to the cover art playing since Oreo (8.0), and in 10 it got a SeekBar. It is forcefully an API to ally with, and a powerful API it is, removing the need to use a whole bunch of custom code to achieve what once was. Easier to maintain and improve. Win!
