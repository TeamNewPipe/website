...
This is a special notification type available for media apps since Android (5.0) Lollipop, colour-matching its theme to the cover art playing, and in 10 got a SeekBar. It is a powerful API removing the need to use a whole bunch of custom code to achieve what once was. Easier to maintain and improve. Win!
